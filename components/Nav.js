    ...
    <nav className={styles.nav} role="navigation">
      ...
      <ul className={`${styles.nav__menu} ${collapsed ? styles.nav__collapsed : styles.nav__open}`}>
        ...
        <li className={`${styles.nav__has__submenu} ${router.pathname.includes("/inspiration") ? styles.nav__menu__active : ''}`}>
          ...
          <ul className={styles.nav__submenu}>
          <li className={`${styles.nav__submenu__item} ${router.pathname.includes("/inspiration/images") ? styles.nav__menu__active : ''}`}>
            ...
            <li className={`${styles.nav__submenu__item} ${router.pathname.includes("/inspiration/quotes") ? styles.nav__menu__active : ''}`}>
